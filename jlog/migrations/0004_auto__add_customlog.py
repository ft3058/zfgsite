...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CustomLog'
        db.create_table(u'jlog_customlog', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.CharField')(default='', max_length=100, null=True)),
            ('host', self.gf('django.db.models.fields.TextField')(default='', null=True)),
            ('ip', self.gf('django.db.models.fields.CharField')(default='', max_length=100, null=True)),
            ('cmd', self.gf('django.db.models.fields.TextField')(default='', null=True)),
            ('title', self.gf('django.db.models.fields.CharField')(default='', max_length=50, null=True)),
        ...
        db.send_create_signal(u'jlog', ['CustomLog'])


    def backwards(self, orm):
        # Deleting model 'CustomLog'
        db.delete_table(u'jlog_customlog')
    ...
    models = {
        ...
        u'jlog.customlog': {
            'Meta': {'object_name': 'CustomLog'},
            'cmd': ('django.db.models.fields.TextField', [], {'default': "''", 'null': 'True'}),
            'datetime': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'host': ('django.db.models.fields.TextField', [], {'default': "''", 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ip': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100', 'null': 'True'}),
            'result': ('django.db.models.fields.TextField', [], {'default': "''", 'null': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50', 'null': 'True'}),
            'user': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100', 'null': 'True'})
        },
        u'jlog.execlog': {
