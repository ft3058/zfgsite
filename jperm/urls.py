...
urlpatterns = patterns('jperm.views',
                       ...
                       url(r'^domain/list/$', perm_rule_list_domains, name='rule_list_domains'),

                       url(r'^rule/add/$', perm_rule_add, name='rule_add'),
                       # new
                       url(r'^rule/add_domains/$', perm_rule_domains_add, name='rule_domains_add'),

                       url(r'^rule/detail/$', perm_rule_detail, name='rule_detail'),
                       #
                       url(r'^rule_domains/detail/$', perm_rule_domains_detail, name='rule_domains_detail'),

                       url(r'^rule/edit/$', perm_rule_edit, name='rule_edit'),
                       url(r'^rule_domains/edit/$', perm_rule_domains_edit, name='rule_domains_edit'),

                       url(r'^rule/del/$', perm_rule_delete, name='rule_del'),
                       url(r'^rule_domains/del/$', perm_rule_domains_delete, name='rule_domains_del'),
