...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field domain_group on 'Asset'
        m2m_table_name = db.shorten_name(u'jasset_asset_domain_group')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('asset', models.ForeignKey(orm[u'jasset.asset'], null=False)),
            ('domaingroup', models.ForeignKey(orm[u'jasset.domaingroup'], null=False))
        ))
        db.create_unique(m2m_table_name, ['asset_id', 'domaingroup_id'])


    def backwards(self, orm):
        # Removing M2M table for field domain_group on 'Asset'
        db.delete_table(db.shorten_name(u'jasset_asset_domain_group'))
    ...
    models = {
        ...
        u'jasset.asset': {
            ...
            'domain_group': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['jasset.DomainGroup']", 'symmetrical': 'False', 'blank': 'True'}),
