...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Domains.module_name'
        db.add_column(u'jasset_domains', 'module_name',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Domains.comment'
        db.add_column(u'jasset_domains', 'comment',
                      self.gf('django.db.models.fields.CharField')(max_length=160, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Domains.module_name'
        db.delete_column(u'jasset_domains', 'module_name')

        # Deleting field 'Domains.comment'
        db.delete_column(u'jasset_domains', 'comment')
