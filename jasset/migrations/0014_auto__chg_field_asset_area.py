...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Asset.area'
        db.alter_column(u'jasset_asset', 'area', self.gf('django.db.models.fields.CharField')(max_length=2, null=True))

    def backwards(self, orm):

        # Changing field 'Asset.area'
        db.alter_column(u'jasset_asset', 'area', self.gf('django.db.models.fields.CharField')(max_length=1, null=True))
