...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AssetGroup1.script_path'
        db.add_column(u'jasset_assetgroup1', 'script_path',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AssetGroup1.script_path'
        db.delete_column(u'jasset_assetgroup1', 'script_path')
