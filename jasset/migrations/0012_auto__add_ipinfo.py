...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'IpInfo'
        db.create_table(u'jasset_ipinfo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ip', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True)),
            ('hostname', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True)),
            ...
            ('loc', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True)),
            ('org', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('comment', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('cdt', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
        ))
        db.send_create_signal(u'jasset', ['IpInfo'])


    def backwards(self, orm):
        # Deleting model 'IpInfo'
        db.delete_table(u'jasset_ipinfo')
    ...
    models = {
        ...
        u'jasset.asset': {
            ...
            'area': ('django.db.models.fields.CharField', [], {'max_length': '1', 'null': 'True', 'blank': 'True'}),
