...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AssetGroup1'
        db.create_table(u'jasset_assetgroup1', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=80)),
            ('comment', self.gf('django.db.models.fields.CharField')(max_length=160, null=True, blank=True)),
        ))
        db.send_create_signal(u'jasset', ['AssetGroup1'])

        # Adding M2M table for field group1 on 'Asset'
        m2m_table_name = db.shorten_name(u'jasset_asset_group1')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('asset', models.ForeignKey(orm[u'jasset.asset'], null=False)),
            ('assetgroup1', models.ForeignKey(orm[u'jasset.assetgroup1'], null=False))
        ))
        db.create_unique(m2m_table_name, ['asset_id', 'assetgroup1_id'])


    def backwards(self, orm):
        # Deleting model 'AssetGroup1'
        db.delete_table(u'jasset_assetgroup1')

        # Removing M2M table for field group1 on 'Asset'
        db.delete_table(db.shorten_name(u'jasset_asset_group1'))
