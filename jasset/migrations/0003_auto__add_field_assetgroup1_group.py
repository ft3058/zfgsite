...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AssetGroup1.group'
        db.add_column(u'jasset_assetgroup1', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['jasset.AssetGroup'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AssetGroup1.group'
        db.delete_column(u'jasset_assetgroup1', 'group_id')
