...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Domains.full_path'
        db.add_column(u'jasset_domains', 'full_path',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Domains.domain_host'
        db.add_column(u'jasset_domains', 'domain_host',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Domains.port'
        db.add_column(u'jasset_domains', 'port',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Domains.full_path'
        db.delete_column(u'jasset_domains', 'full_path')

        # Deleting field 'Domains.domain_host'
        db.delete_column(u'jasset_domains', 'domain_host')

        # Deleting field 'Domains.port'
        db.delete_column(u'jasset_domains', 'port')
