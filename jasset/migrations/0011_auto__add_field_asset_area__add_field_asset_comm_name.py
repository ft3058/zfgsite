...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Asset.area'
        db.add_column(u'jasset_asset', 'area',
                      self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Asset.comm_name'
        db.add_column(u'jasset_asset', 'comm_name',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Asset.area'
        db.delete_column(u'jasset_asset', 'area')

        # Deleting field 'Asset.comm_name'
        db.delete_column(u'jasset_asset', 'comm_name')
