...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'jasset_domains', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('path1', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
            ('path2', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
            ('path3', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
            ('path4', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
            ('path5', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
            ('path6', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
            ('path7', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
            ('path8', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
        ))
        db.send_create_signal(u'jasset', ['Domains'])

        # Adding M2M table for field domain on 'Asset'
        m2m_table_name = db.shorten_name(u'jasset_asset_domain')
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'jasset_domains')

        # Removing M2M table for field domain on 'Asset'
        db.delete_table(db.shorten_name(u'jasset_asset_domain'))
    ...
    models = {
        ...
        u'jasset.asset': {
            ...
            'domain': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['jasset.Domains']", 'symmetrical': 'False', 'blank': 'True'}),
