...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IpInfo.asset'
        db.add_column(u'jasset_ipinfo', 'asset',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['jasset.Asset']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IpInfo.asset'
        db.delete_column(u'jasset_ipinfo', 'asset_id')
