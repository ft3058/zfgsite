...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AssetGroup1.module_path'
        db.add_column(u'jasset_assetgroup1', 'module_path',
                      self.gf('django.db.models.fields.CharField')(max_length=6000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AssetGroup1.module_path'
        db.delete_column(u'jasset_assetgroup1', 'module_path')
